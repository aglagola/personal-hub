                        ...
                        <div className="grid gap-6">
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="group relative grid grid-cols-1 md:grid-cols-2 gap-8 items-start border border-stone-200 dark:border-stone-800 rounded-lg p-8 hover:bg-stone-50 dark:hover:bg-stone-900/50 transition-colors">
                                    <div>
                                        <div className="aspect-video w-full rounded-md bg-stone-200 dark:bg-stone-800 object-cover" />
                                    </div>
                                    <div className="flex flex-col h-full">
                                        <h2 className="text-2xl font-serif font-bold text-stone-900 dark:text-stone-50 mb-2">Project Name {i}</h2>
                                        <p className="text-stone-600 dark:text-stone-300 mb-6 flex-1">
                                            Detailed description of the project. What problem did it solve? What technologies were used?
                                            What was the outcome? This is a place to show off the technical details.
                                        </p>
